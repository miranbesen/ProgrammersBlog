...
namespace ProgrammersBlog.Data.Concrete.EntityFramework.Mappings
{
    ...
    public class ArticleMap : IEntityTypeConfiguration<Article>  //Mapping işlemi olduğunu anlamak için IEntityTypeConfiguration interface'sinden implement ediyoruz.
    {
        public void Configure(EntityTypeBuilder<Article> builder)
        {
            ...
            builder.HasData( //db'de başlatıldığı anda veri ekliyoruz.
                new Article
                {
                    Id = 1,
                    CategoryId = 1,
                ...
                new Article
                {
                    ...
                    SeoTags = "C++ 11 ve 19 Yenilikleri", // bunlar arka planda arama motorlarının görecegi bilgiler.
                    SeoAuthor = "Miran Besen",
                    Date = DateTime.Now,
                    IsActive = true,
                    IsDeleted = false, //bu entity silinmiş bir veri değil.
                ...
                new Article
                {
                    ...
                    SeoTags = "JavaScript ES2019 ve ES2020 yenilikleri", // bunlar arka planda arama motorlarının görecegi bilgiler.
                    SeoAuthor = "Miran Besen",
                    Date = DateTime.Now,
                    IsActive = true,
                    IsDeleted = false, //bu entity silinmiş bir veri değil.
...
//Note: bazen uygulama içinde ["] işaretini kullanıyor. Fakat bunu anlamıyor. Anlaması için [ \" ] şeklinde yazmamız gerek.
